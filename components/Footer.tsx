      ...
      <div className="max-w-[1160px] mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12 mb-8">
          <div>
            ...
            <p className="text-white/60 text-[0.85rem] leading-relaxed max-w-[240px]">
              Evidence-based health education for everyone. Making medicine simple, accessible, and actionable.
            </p>
          ...
          <div>
            ...
            {[
              ...
              <a key={label as string} href={href as string}
                ...
                className="block text-white/60 text-[0.85rem] mb-2 no-underline hover:text-white transition-colors">
                {label}
              </a>
            ))}
          </div>
